...
export default function MessagesPage() {
  return (
    <div className="h-[calc(100vh-250px)] animate-in fade-in slide-in-from-bottom-4 duration-500 font-sans flex border border-border/10 rounded-[2.5rem] bg-surface/50 overflow-hidden shadow-2xl">
      ...
      <div className="flex-1 flex flex-col bg-background/50 relative">
        ...
        <div className="flex-1 p-8 overflow-y-auto space-y-6 no-scrollbar">
          <div className="flex gap-4">
            ...
            <div className="bg-foreground/5 p-4 rounded-2xl rounded-tl-none text-sm font-medium max-w-[70%]">
              안녕하세요 유저님! 등록해주신 포트폴리오(Nansa-UI-System)를 매우 인상 깊게 보았습니다.
              Toss Core팀에서 합류 제안을 드리고 싶은데, 혹시 가벼운 커피챗 가능하실까요?
            </div>
          </div>
          ...
          <div className="flex gap-4 flex-row-reverse">
            ...
            <div className="bg-primary text-white p-4 rounded-2xl rounded-tr-none text-sm font-medium max-w-[70%]">
              안녕하세요 매니저님! 좋게 봐주셔서 감사합니다. 네, 커피챗 제안 감사히 수락하겠습니다.
              다음 주 중으로 시간 괜찮으실까요?
            </div>
          </div>
        ...
        <div className="px-6 py-4 bg-primary/5 border-t border-primary/20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[10px] font-bold text-primary italic">
              AGENT ASSISTING: "목요일 오후 2시가 유저님의 일정상 가장 여유롭습니다. 이 시간을
              추천해요."
            </p>
          </div>
          <Badge
            variant="default"
            className="text-[9px] font-bold uppercase tracking-wider bg-primary/10 text-primary border-none rounded-full"
          >
            AI Recommendation
          </Badge>
        </div>
        ...
        <div className="p-6 bg-surface/90 border-t border-border/10 backdrop-blur-md">
          <div className="relative">
            <Textarea
              ...
              className="min-h-[50px] bg-foreground/5 border-none focus-visible:ring-primary rounded-2xl p-4 pr-12 text-sm font-medium resize-none"
            />
            <button
              type="button"
      ...
      {/* Right Sidebar - Recruitment Info (Optional) */}
      <div className="w-64 border-l border-border/10 p-6 space-y-8 bg-surface/40 hidden lg:block">
        <div className="space-y-4">
          ...
          <div>
            <p className="text-sm font-bold italic tracking-tight uppercase">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10 space-y-3">
            ...
            <p className="text-[10px] font-medium leading-relaxed leading-relaxed">
              이 기업은 최근 3개월간 동일 포지션 이직자의 **재직 만족도가 4.8/5.0**으로 매우
              높습니다.
            </p>
          </div>
        </div>
